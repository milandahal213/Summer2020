...
"""
UPDATED Example LEGO® MINDSTORMS® EV3 Puppy Program
-------------------------------------------
...
class Puppy:
    ...
    #replaced HURT, HEART, SQUINTY with AWAKE,DIZZY,PINCHED_MIDDLE
    ...
    def reset(self):
        ...
        self.pet_target = randint(3, 6)
        # Pick a random number of time to feed the puppy.
        self.feed_target = randint(2,4)
    ...
    def update_eyes(self):
        if self.eyes_timer_1.time() > self.eyes_timer_1_end:
            ...
            if self.eyes == self.SLEEPING_EYES:
                self.eyes_timer_1_end = randint(1, 5) * 1000
        ...
        if self.eyes_timer_2.time() > self.eyes_timer_2_end:
            ...
            if self.eyes != self.SLEEPING_EYES:
                self.eyes_timer_2_end = randint(1, 10) * 1000
